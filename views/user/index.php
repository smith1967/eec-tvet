<div class="row">
    <div class="col-lg-3 col-md-3">
        ...
        <div class="small-box bg-primary btn-insert" >
            ...
            <a href="<?php echo site_url('user/index') ?>" class="small-box-footer">รายละเอียด <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- /.col -->
    <!-- /.col -->
    <div class="col-lg-3 col-md-3">
        ...
        <div class="small-box bg-yellow btn-insert" id="boxInsert" data-toggle="modal" data-target="#formModal">
            ...
            <a href="<?php echo site_url('user/new') ?>" class="small-box-footer">จัดการ <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div>
    <!-- /.col -->
