              ...
              <div class="box-body">                 
                <div class="col-md-6 col-lg-12">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="shortcourse_code"  data-width="100%">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="school_id"  data-width="100%">
                     <option value="">--เลือก--</option>
                     <?php
                      if($results1->num_rows > 0){                       
                        while($row1 = $results1->fetch_assoc()) {
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="date_rang" class="form-control pull-right" id="date_rang" data-width="100%">
                    </div>
                    <!-- /.input group -->
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="trainee_hour" data-width="100%">
                      <option value="">--เลือก--</option>
                      <?php 
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="trainee_amount" data-width="100%">
                      <option value="">--เลือก--</option>
                      <?php 
                      for($num=1;$num <=300;$num++){
                        ?>
